...
def InceptionV3_model(input_shape,class_number):
    baseModel = InceptionV3(include_top=False, input_tensor=keras.layers.Input(shape=input_shape))
...
model = InceptionV3_model(shape,class_number)
