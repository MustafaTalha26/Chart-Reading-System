...
def DenseNet121_model(input_shape,class_number):
    baseModel = DenseNet121(include_top=False, input_tensor=keras.layers.Input(shape=input_shape))
...
model = DenseNet121_model(shape,class_number)
