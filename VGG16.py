...
def VGG16_model(learning_rate, input_shape,class_number):
    baseModel = VGG16(include_top=False, input_tensor=keras.layers.Input(shape=input_shape))
...
model = VGG16_model(lr,shape,class_number)
