...
def Xception_model(learning_rate, input_shape,class_number):
    baseModel = Xception(include_top=False, input_tensor=keras.layers.Input(shape=input_shape))
...
model = Xception_model(lr,shape,class_number)
